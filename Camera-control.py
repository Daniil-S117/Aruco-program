...
EVIDENCE = {'IP': '10.16.10.248', 'Port': 8080, 'Login': "admin", 'Password': "Abc.12345", 'Address': "rtsp://10.16.10.248:554/ch0/stream0", "Thermal": "rtsp://10.16.10.248:554/ch1/stream0"}
LTV = {'IP': '10.11.15.45', 'Port': 80, 'Login': "admin", 'Password': "pass135790!",
       'Address': "rtsp://10.11.15.451:554/ch0/stream0"}
_camera = LTV
mycam = ONVIFCamera(_camera['IP'], _camera['Port'], _camera['Login'], _camera['Password'])
